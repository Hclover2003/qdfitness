...
void initState(){
  ...
  Widget build(BuildContext context) {
    return SfCartesianChart(
            ...
            title: ChartTitle(text: "Weekly Calorie Summary", textStyle: TextStyle(fontSize: 16)),
            ...
            series: <ChartSeries>[
              LineSeries<WeekData, String>(
                ...
                name: "Food",
                dataLabelSettings: DataLabelSettings(isVisible: true, color: Colors.blue[800])
              ),
              LineSeries<WeekData, String>(
                dataSource:  widget.weekdata,
                xValueMapper: (WeekData weekdata, _) => weekdata.date,
                ...
                name: "Exercise",                
                dataLabelSettings: DataLabelSettings(isVisible: true, color: Colors.red[800])
              )
            ]
          );
  }
